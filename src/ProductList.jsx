                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Nature's Oasis</h3>
                                <i style={{ color: 'white' }}>Creating a Green Paradise</i>
                            </div>
                        </a>
                    </div>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                            ...
                            fill="none" stroke="#faf9f9" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" id="mainIconPathAttribute"></path></svg>
                            <div className='cart_quantity_count'>{totalQuantity}</div></h1></a></div>
                            {/* Added <dic className=''>{totalQuantity} to show how many items are in cart */}
                </div>
            </div>
            {!showCart ? (
                <div className="product-grid">
                        ...
                        <div key={index}>
                            {/* Changed order so h1 was in a div AND added h1 to CSS*/}
...
>                                       {addedToCart[plant.name] ? "Added to Cart" : "Add to Cart"}</button>
                                            {/* ${...} Template literal addedTpCart[plant.name] access value ? (ternary operator)
                                            If addedToCart[plant.name] is truthy (meaning the plant is in the cart), it returns the string 'added-to-cart'.
                                            Otherwise (if the plant is not in the cart), it returns an empty string ('').*/}
                                </div>
                                ))}
                            </div>
                        </div>
